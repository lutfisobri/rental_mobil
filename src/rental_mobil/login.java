...
public class login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBox2.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Toyota Avanza", "Daihatsu Xenia" }));

        buttonGroup1.add(jRadioButton1);
        jRadioButton1.setText("Pakai Sopir");

        buttonGroup1.add(jRadioButton2);
        jRadioButton2.setText("Tanpa Sopir");
